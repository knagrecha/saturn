...
"""
	This file just exists to correct an error I noticed with FSDP multiprocessing.
	https://github.com/pytorch/pytorch/pull/90597
"""
...
class ProcessExitedException(ProcessException):
    ...
    def __reduce__(self):
        return (
            type(self),
            (self.msg, self.error_index, self.pid,
             self.exit_code, self.signal_name),
        )
...
class SpawnContext(ProcessContext):
    def __init__(self, processes, error_queues):
        warnings.warn(
            'SpawnContext is renamed to ProcessContext since 1.4 release.')
